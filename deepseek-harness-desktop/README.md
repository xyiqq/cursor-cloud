...
https://github.com/xyiqq/cursor-cloud/releases/tag/v0.4.2

- **Windows x64 ZIP：** https://github.com/xyiqq/cursor-cloud/releases/download/v0.4.2/DeepSeek-Harness-0.4.2-win-x64.zip
- **macOS Apple Silicon (arm64)：** https://github.com/xyiqq/cursor-cloud/releases/download/v0.4.2/DeepSeek-Harness-0.4.2-mac-arm64.zip
- **macOS Intel (x64)：** https://github.com/xyiqq/cursor-cloud/releases/download/v0.4.2/DeepSeek-Harness-0.4.2-mac-x64.zip
