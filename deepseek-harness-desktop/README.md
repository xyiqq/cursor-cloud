...
- **滑动变祖器**（[Liang-Saint-Slider](https://github.com/BruzWJ/Liang-Saint-Slider)：模型 + 思考档位）
- **ZIP OTA**：启动自动检测 GitHub Releases 新版本并下载安装

## 下载（v0.4.3）

https://github.com/xyiqq/cursor-cloud/releases/tag/v0.4.3

- **Windows x64 ZIP：** https://github.com/xyiqq/cursor-cloud/releases/download/v0.4.3/DeepSeek-Harness-0.4.3-win-x64.zip
- **macOS Apple Silicon (arm64)：** https://github.com/xyiqq/cursor-cloud/releases/download/v0.4.3/DeepSeek-Harness-0.4.3-mac-arm64.zip
- **macOS Intel (x64)：** https://github.com/xyiqq/cursor-cloud/releases/download/v0.4.3/DeepSeek-Harness-0.4.3-mac-x64.zip
...
内置含 **滑动变祖器**（模型 + 思考档位滑条，点输入框旁模型位打开）。
